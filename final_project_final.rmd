...
p2 <- ggplot(data = fifa_test, aes(x=height_cm, y=weight_kgs))+
  geom_point()
...
par(mfrow = c(1, 2))
plot(fifa$value_euro, fifa$overall_rating, main = "Overall Rating vs. Value Euro", xlab="Value Euro", ylab="Overall Rating")
plot(fifa$wage_euro, fifa$overall_rating, main = "Overall Rating vs. Wage Euro", xlab="Wage Euro", ylab="Overall Rating")
```
...
```{r, fig.height=3, fig.width=6, echo=FALSE}
par(mfrow = c(1, 2))
plot(log(fifa$value_euro), fifa$overall_rating, main = "Overall Rating vs. Log Value Euro", xlab="Log Value Euro", ylab="Overall Rating")
plot(log(fifa$wage_euro), fifa$overall_rating, main = "Overall Rating vs. Log Wage Euro", xlab="Log Wage Euro", ylab="Overall Rating")
```
...
Our R-squared value is `r r_squared`. We have a moderately strong positive relationship between a player's overall rating and their market value from a correlation of `r correlation`, As we can see, this is horrendous. Let's look into a transformation!
